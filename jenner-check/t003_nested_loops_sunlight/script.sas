/* From "Data Science II - HHS 4500/SAS/In-Class & Homework/Nested_Loop_Aiden_Rader.sas":
 * Using nested SAS loops, create data that simulate the relationship between sunlight and temperature
 * (during both winter and summer). You will need to create at least 3 variables (sunlight, temperature, summer).
